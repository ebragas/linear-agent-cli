...
linear project create --name "Project Name" --team Main --agent <id>
linear project create --name "Project Name" --team Main --description "..." --start-date 2026-03-01 --target-date 2026-06-30 --agent <id>
